...
void drawCar() {
    ...
    glTexCoord2f(0.995f, 0.005f); glVertex3f(0.2f, 0.25f, 0.35f);
    glTexCoord2f(2.995f, 2.995f); glVertex3f(0.2f,  0.35f, 0.35f);
    glTexCoord2f(0.005f, 0.995f); glVertex3f( 0.2f,  0.35f, 0.45f);
    glTexCoord2f(0.005f, 0.005f); glVertex3f( 0.2f, 0.25f, 0.45f);
    glEnd();
}
